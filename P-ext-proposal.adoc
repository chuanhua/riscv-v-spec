...
rt.H[_x_] = (ra.H[_x_] + rb.H[_x_]) u>> 1;
...
rt.H[_x_] = (ra.H[_x_] + rb.H[_x-1_]) u>> 1; +
rt.H[_x-1_] = (ra.H[_x-1_] – rb.H[_x_]) u>> 1;
...
rt.H[_x_] = (ra.H[_x_] + rb.H[_x_]) u>> 1; +
rt.H[_x-1_] = (ra.H[_x-1_] – rb.H[_x-1_]) u>> 1;
...
rt.B[_x_] = (ra.B[_x_] + rb.B[_x_]) u>> 1;
...
|11 |SWAP16 rt, ra |Swap Halfword within WoRd
...
|11 |SWAP8 rt, ra |Swap Byte within HalfwoRd
...
(32 = 32 + 8x8 + 8x8 + 8x8 + 8x8) a|
rt.W[_x_] = rt.W[_x_] + ra.W[_x_].B[3]*rb.W[_x_].B[3] + ra.W[_x_]. B[2]*rb.W[_x_].B[2] + ra.W[_x_].B[1]*rb.W[_x_].B[1] + ra.W[_x_].B[0]* rb.W[_x_].B[0]);
...
|===
^.^|No. ^.^|Mnemonic ^.^|Instruction ^.^|Operation
|1 |RADDW rt, ra, rb |32-bit Signed Halving Addition a|
res = (ra.W[0] + rb.W[0]) s>> 1;

rt = SE(res);

|2 |URADDW rt, ra, rb |32-bit Unsigned Halving Addition a|
res = (ra.W[0] + rb.W[0]) u>> 1;

rt = SE(res);

|3 |RSUBW rt, ra, rb |32-bit Signed Halving Subtraction a|
res = (ra.W[0] - rb.W[0]) s>> 1;

rt = SE(res);

|4 |URSUBW rt, ra, rb |32-bit Unsigned Halving Subtraction a|
res = (ra.W[0] - rb.W[0]) u>> 1;

rt = SE(res);

|5 |MAXW rt, ra, rb |32-bit Signed Word Maximum a|
if (ra.W[0] >= rb.W[0]) \{
...
|6 |MINW rt, ra, rb |32-bit Signed Word Minimum a|
if (ra.W[0] >= rb.W[0]) \{
...
|7 |MULR64 rt, ra, rb |Multiply Word Unsigned to 64-bit data a|
RV32:
...
|8 |MULSR64 rt, ra, rb |Multiply Word Signed to 64-bit data a|
RV32:
...
|===
^.^|No. ^.^|Mnemonic ^.^|Instruction ^.^|Operation
|1 |RDOV Rt |Read ucode.OV to Rt. |Rt = ZE(ucode.OV)
|2 |CLROV |Clear ucode.OV flag |ucode.OV = 0
|===
...
rt.W[_x_] = (ra.W[_x_] + rb.W[_x_]) u>> 1;
...
rt.W[_x_] = (ra.W[_x_] + rb.W[_x-1_]) u>> 1; +
rt.W[_x-1_] = (ra.W[_x-1_] – rb.W[_x_]) u>> 1;
...
rt.W[_x_] = (ra.W[_x_] + rb.W[_x_]) u>> 1; +
rt.W[_x-1_] = (ra.W[_x-1_] – rb.W[_x-1_]) u>> 1;
...
*Intrinsic functions:*
 ...
 unsigned long __nds__add8(unsigned long a, unsigned long b);

 RV32:
  uint8x4_t __nds__v_uadd8(uint8x4_t a, uint8x4_t b);
  int8x4_t __nds__v_sadd8(int8x4_t a, int8x4_t b);
 RV64:
  uint8x8_t __nds__v_uadd8(uint8x8_t a, uint8x8_t b);
  int8x8_t __nds__v_sadd8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__add16(unsigned long a, unsigned long b);

 RV32:
  uint16x2_t __nds__v_uadd16(uint16x2_t a, uint16x2_t b);
  int16x2_t __nds__v_sadd16(int16x2_t a, int16x2_t b);
 RV64:
  uint16x4_t __nds__v_uadd16(uint16x4_t a, uint16x4_t b);
  int16x4_t __nds__v_sadd16(int16x4_t a, int16x4_t b);
...
The odd “2__d__+1” register of the pair contains the high 32-bit of the result
and the even “2__d__” register of the pair contains the low 32-bit of the result.
...
*Intrinsic functions:*
 ...
 long long __nds__sadd64(long long a, long long b);
 unsigned long long __nds__uadd64(unsigned long long a, unsigned long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__bitrev(unsigned long a, unsigned long b);
...
[cols="7*^.^"]
|===
l|31    30 l|29    25 l|24    20 l|19    15 l|14    12 l|11    7 l|6    0
|BPICK +
11 |Rc |Rs2 |Rs1 |010 |Rd
|GE80B +
1111111
|===
...
*Intrinsic functions:*
 ...
 unsigned long __nds__bpick(unsigned long a, unsigned long b, unsigned long c);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clrs8(unsigned long a);

 RV32:
  uint8x4_t __nds__v_clrs8(int8x4_t a);
 RV64:
  uint8x8_t __nds__v_clrs8(int8x8_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clrs16(unsigned long a);

 RV32:
  uint16x2_t __nds__v_clrs16(int16x2_t a);
 RV64:
  uint16x4_t __nds__v_clrs16(int16x4_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clrs32(unsigned long a);

 RV64:
  uint32x2_t __nds__v_clrs32(int32x2_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clo8(unsigned long a);

 RV32:
   uint8x4_t __nds__v_clo8(uint8x4_t a);
 RV64:
   uint8x8_t __nds__v_clo8(uint8x8_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clo16(unsigned long a);

 RV32:
   uint16x2_t __nds__v_clo16(uint16x2_t a);
 RV64:
   uint16x4_t __nds__v_clo16(uint16x4_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clo32(unsigned long a);

 RV64:
   uint32x2_t __nds__v_clo32(uint32x2_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clz8(unsigned long a);

 RV32:
   uint8x4_t __nds__v_clz8(uint8x4_t a);
 RV64:
   uint8x8_t __nds__v_clz8(uint8x8_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clz16(unsigned long a);

 RV32:
   uint16x2_t __nds__v_clz16(uint16x2_t a);
 RV64:
   uint16x4_t __nds__v_clz16(uint16x4_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__clz32(unsigned long a);

 RV64:
   uint32x2_t __nds__v_clz32(uint32x2_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__cmpeq8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_scmpeq8(int8x4_t a, int8x4_t b);
   uint8x4_t __nds__v_ucmpeq8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_scmpeq8(int8x8_t a, int8x8_t b);
   uint8x8_t __nds__v_ucmpeq8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__cmpeq16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_scmpeq16(int16x2_t a, int16x2_t b);
   uint16x2_t __nds__v_ucmpeq16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_scmpeq16(int16x4_t a, int16x2_t b);
   uint16x4_t __nds__v_ucmpeq16(uint16x4_t a, uint16x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__cras16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ucras16(uint16x2_t a, uint16x2_t b);
   int16x2_t __nds__v_scras16(int16x2_t a, int16x2_t b);
 RV64:
   uint16x4_t __nds__v_ucras16(uint16x4_t a, uint16x4_t b);
   int16x4_t __nds__v_scras16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__crsa16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ucrsa16(uint16x2_t a, uint16x2_t b);
   int16x2_t __nds__v_scrsa16(int16x2_t a, int16x2_t b);
 RV64:
   uint16x4_t __nds__v_ucrsa16(uint16x4_t a, uint16x4_t b);
   int16x4_t __nds__v_scrsa16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__insb(unsigned long t, unsigned long a, unsigned long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kabs8(unsigned long a);

 RV32:
   int8x4_t __nds__v_kabs8(int8x4_t a);
 RV64:
   int8x8_t __nds__v_kabs8(int8x8_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kabs16(unsigned long a);

 RV32:
   int16x2_t __nds__v_kabs16(int16x2_t a);
 RV64:
   int16x4_t __nds__v_kabs16(int16x4_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kabsw(signed long a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kadd8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_kadd8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_kadd8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kadd16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_kadd16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_kadd16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__kadd64(long long a, long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kcras16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_kcras16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_kcras16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kcrsa16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_kcrsa16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_kcrsa16(int16x4_t a, int16x4_t b);
...
* KDMBB
 ...
 long __nds__kdmbb(unsigned int a, unsigned int b);

 RV32:
   long __nds__v_kdmbb(int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_kdmbb(int16x4_t a, int16x4_t b);

* KDMBT

 long __nds__kdmbt(unsigned int a, unsigned int b);

 RV32:
   long __nds__v_kdmbt(int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_kdmbt(int16x4_t a, int16x4_t b);

* KDMTT

 long __nds__kdmtt(unsigned int a, unsigned int b);

 RV32:
   long __nds__v_kdmtt(int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_kdmtt(int16x4_t a, int16x4_t b);
...
* KDMABB
 ...
 long __nds__kdmabb(long t, unsigned int a, unsigned int b);

 RV32:
   long __nds__v_kdmabb(long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_kdmabb(long t, int16x4_t a, int16x4_t b);


* KDMABT

 long __nds__kdmabt(long t, unsigned int a, unsigned int b);

 RV32:
   long __nds__v_kdmabt(long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_kdmabt(long t, int16x4_t a, int16x4_t b);

* KDMATT

 long __nds__kdmatt(long t, unsigned int a, unsigned int b);

 RV32:
   long __nds__v_kdmatt(long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_kdmatt(long t, int16x4_t a, int16x4_t b);
...
* KHM8
 ...
 unsigned long __nds__khm8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_khm8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_khm8(int8x8_t a, int8x8_t b);

* KHMX8

 unsigned long __nds__khmx8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_khmx8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_khmx8(int8x8_t a, int8x8_t b);
...
* KHM16
 ...
 unsigned long __nds__khm6(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_khm16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_khm16(int16x4_t a, int16x4_t b);

* KHMX16

 unsigned long __nds__khmx16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_khmx16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_khmx16(int16x4_t a, int16x4_t b);
...
* KHMBB
 ...
 long __nds__khmbb(unsigned int a, unsigned int b);

 RV32:
   long __nds__v_khmbb(int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_khmbb(int16x4_t a, int16x4_t b);


* KHMBT

 long __nds__khmbt(unsigned int a, unsigned int b);

 RV32:
   long __nds__v_khmbt(int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_khmbt(int16x4_t a, int16x4_t b);

* KHMTT

 long __nds__khmtt(unsigned int a, unsigned int b);

 RV32:
   long __nds__v_khmtt(int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_khmtt(int16x4_t a, int16x4_t b);
...
* KMABB
 ...
 long __nds__kmabb(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmabb(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmabb(int32x2_t t, int16x4_t a, int16x4_t b);

* KMABT

 long __nds__kmabt(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmabt(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmabt(int32x2_t t, int16x4_t a, int16x4_t b);

* KMATT

long __nds__kmatt(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmatt(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmatt(int32x2_t t, int16x4_t a, int16x4_t b);
...
* KMADA
 ...
 long __nds__kmada(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmada(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmada(int32x2_t t, int16x4_t a, int16x4_t b);

* KMAXDA

 long __nds__kmaxda(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmaxda(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmaxda(int32x2_t t, int16x4_t a, int16x4_t b);
...
* KMADS
 ...
 long __nds__kmads(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmads(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmads(int32x2_t t, int16x4_t a, int16x4_t b);

* KMADRS

 long __nds__kmadrs(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmadrs(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmadrs(int32x2_t t, int16x4_t a, int16x4_t b);

* KMAXDS

 long __nds__kmaxds(long t, unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmaxds(long t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmaxds(int32x2_t t, int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__kmar64(long long t, long a, long b);

 RV64:
   long long __nds__v_kmar64(long long t, int32x2_t a, int32x2_t b);
...
* KMDA
 ...
 long __nds__kmda(unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmda(int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmda(int16x4_t a, int16x4_t b);

* KMXDA

 long __nds__kmxda(unsigned long a, unsigned long b);

 RV32:
   long __nds__v_kmxda(int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmxda(int16x4_t a, int16x4_t b);
...
* KMMAC
 ...
 long __nds__kmmac(long t, long a, long b);

 RV64:
   int32x2_t __nds__v_kmmac(int32x2_t t, int32x2_t a, int32x2_t b);

* KMMAC.u

 long __nds__kmmac_u(long t, long a, long b);

 RV64:
   int32x2_t __nds__v_kmmac_u(int32x2_t t, int32x2_t a, int32x2_t b);
...
* KMMAWB
 ...
 long __nds__kmmawb(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawb(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawb(int32x2_t t, int32x2_t a, int16x4_t b);

* KMMAWB.u

 long __nds__kmmawb_u(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawb_u(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawb_u(in32x2_t t, int32x2_t a, int16x4_t b);
...
* KMMAWB2
 ...
 long __nds__kmmawb2(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawb2(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawb2(in32x2_t t, int32x2_t a, int16x4_t b);

* KMMAWB2.u

 long __nds__kmmawb2_u(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawb2_u(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawb2_u(in32x2_t t, int32x2_t a, int16x4_t b);
...
* KMMAWT
 ...
 long __nds__kmmawt(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawt(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawt(int32x2_t t, int32x2_t a, int16x4_t b);

* KMMAWT.u

 long __nds__kmmawt_u(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawt_u(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawt_u(int32x2_t t, int32x2_t a, int16x4_t b);
...
* KMMAWT2
 ...
 long __nds__kmmawt2(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawt2(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawt2(in32x2_t t, int32x2_t a, int16x4_t b);

* KMMAWT2.u

 long __nds__kmmawt2_u(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmmawt2_u(int t, int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmawt2_u(in32x2_t t, int32x2_t a, int16x4_t b);
...
* KMMSB
 ...
 long __nds__kmmsb(long t, long a, long b);

 RV64:
   int32x2_t __nds__v_kmmsb(int32x2_t t, int32x2_t a, int32x2_t b);

* KMMSB.u

 long __nds__kmmsb_u(long t, long a, long b);

 RV64:
   int32x2_t __nds__ v_kmmsb_u(int32x2_t t, int32x2_t a, int32x2_t b);
...
* KMMWB2
 ...
 long __nds__kmmwb2(long a, unsigned long b);

 RV32:
   int __nds__v_kmmwb2(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmwb2(int32x2_t a, int16x4_t b);


* KMMWB2.u

 long __nds__kmmwb2_u(long a, unsigned long b);

 RV32:
   int __nds__v_kmmwb2_u(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmwb2_u(int32x2_t a, int16x4_t b);
...
* KMMWT2
 ...
 long __nds__kmmwt2(long a, unsigned long b);

 RV32:
   int __nds__v_kmmwt2(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmwt2(int32x2_t a, int16x4_t b);


* KMMWT2.u

 long __nds__kmmwt2_u(long a, unsigned long b);

 RV32:
   int __nds__v_kmmwt2_u(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmmwt2_u(int32x2_t a, int16x4_t b);
...
* KMSDA
 ...
 long __nds__kmsda(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmsda(int t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmsda(int32x2_t t, int16x4_t a, int16x4_t b);

* KMSXDA

 long __nds__kmsxda(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_kmsxda(int t, int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_kmsxda(int32x2_t t, int16x4_t a, int16x4_t b);
...
The odd “2__d__+1” register of the pair contains the high 32-bit of the result and the even “2__d__” register of the pair contains the low 32-bit of the result.
...
*Intrinsic functions:*
 ...
 long long __nds__kmsr64(long long t, long a, long b);

 RV64:
   long long __nds__v_kmsr64(long long t, int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 long __nds__ksllw(long a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ksll8(unsigned long a, unsigned int b);

 RV32:
   int8x4_t __nds__v_ksll8(int8x4_t a, unsigned int b);
 RV64:
   int8x8_t __nds__v_ksll8(int8x8_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ksll16(unsigned long a, unsigned int b);

 RV32:
   int16x2_t __nds__v_ksll16(int16x2_t a, unsigned int b);
 RV64:
   int16x4_t __nds__v_ksll16(int16x4_t a, unsigned int b);
...
* KSLRA8
 ...
 unsigned long __nds__kslra8(unsigned long a, int b);

 RV32:
   int8x4_t __nds__v_kslra8(int8x4_t a, int b);
 RV64:
   int8x8_t __nds__v_kslra8(int8x8_t a, int b);

* KSLRA8.u

 unsigned long __nds__kslra8_u(unsigned long a, int b);

 RV32:
   int8x4_t __nds__v_kslra8_u(int8x4_t a, int b);
 RV64:
   int8x8_t __nds__v_kslra8_u(int8x8_t a, int b);
...
* KSLRA16
 ...
 unsigned long __nds__kslra16(unsigned long a, int b);

 RV32:
   int16x2_t __nds__v_kslra16(int16x2_t a, int b);
 RV64:
   int16x4_t __nds__v_kslra16(int16x4_t a, int b);

* KSLRA16.u

 unsigned long __nds__kslra16_u(unsigned long a, int b);

 RV32:
   int16x2_t __nds__v_kslra16_u(int16x2_t a, int b);
 RV64:
   int16x4_t __nds__v_kslra16_u(int16x4_t a, int b);
...
*Intrinsic functions:*
 ...
 long __nds__kslraw(int a, int b);
...
*Intrinsic functions:*
 ...
 long __nds__kslraw_u(int a, int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kstas16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_kstas16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_kstas16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kstsa16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_kstsa16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_kstsa16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ksub8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_ksub8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_ksub8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ksub16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_ksub16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_ksub16(int16x4_t a, int16x4_t b);
...
The odd “2__d__+1” register of the pair contains the high 32-bit of the operand and the even “2__d__” register of the pair contains the low 32-bit of the operand.
...
*Intrinsic functions:*
 ...
 long long __nds__ksub64(long long a, long long b);
...
* KWMMUL
 ...
 long __nds__kwmmul(long a, long b);

 RV64:
   int32x2_t __nds__v_kwmmul(int32x2_t a, int32x2_t b);

* KWMMUL.u

 long __nds__kwmmul_u(long a, long b);

 RV64:
   int32x2_t __nds__v_kwmmul_u(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__pbsad(unsigned long a, unsigned long b);

 RV32:
   unsigned int __nds__v_pbsad(uint8x4_t a, uint8x4_t b);
 RV64:
   unsigned long __nds__v_pbsad(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__pbsada(unsigned long t, unsigned long a, unsigned long b);

 RV32:
   unsigned int __nds__v_pbsada(unsigned long t, uint8x4_t a, uint8x4_t b);
 RV64:
   unsigned long __nds__v_pbsada(unsigned long t, uint8x8_t a, uint8x8_t b);
...
* PKBB16
 ...
 unsigned long __nds__pkbb16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_pkbb16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_pkbb16(uint16x4_t a, uint16x4_t b);

* PKBT16

 unsigned long __nds__pkbt16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_pkbt16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_pkbt16(uint16x4_t a, uint16x4_t b);

* PKTB16

 unsigned long __nds__pktb16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_pktb16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_pktb16(uint16x4_t a, uint16x4_t b);

* PKTT16

 unsigned long __nds__pktt16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_pktt16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_pktt16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__radd8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_radd8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_radd8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__radd16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_radd16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_radd16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__radd64(long long a, long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rcras16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_rcras16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_rcras16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rcrsa16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_rcrsa16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_rcrsa16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rdov(void);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rstas16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_rstas16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_rstas16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rstsa16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_rstsa16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_rstsa16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rsub8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_rsub8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_rsub8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rsub16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_rsub16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_rsub16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__rsub64(long long a, long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sclip8(unsigned long a, unsigned int b);

 RV32:
   int8x4_t __nds__v_sclip8(int8x4_t a, unsigned int b);
 RV64:
   int8x8_t __nds__v_sclip8(int8x8_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sclip16(unsigned long a, unsigned int b);

 RV32:
   int16x2_t __nds__v_sclip16(int16x2_t a, unsigned int b);
 RV64:
   int16x4_t __nds__v_sclip16(int16x4_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 long __nds__sclip32(long a, unsigned int b);

 RV64:
   int32x2_t __nds__v_sclip32(int32x2_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__scmple8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_scmple8(int8x4_t a, int8x4_t b);
 RV64:
   uint8x8_t __nds__v_scmple8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__scmple16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_scmple16(int16x2_t a, int16x2_t b);
 RV64:
   uint16x4_t __nds__v_scmple16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__scmplt8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_scmplt8(int8x4_t a, int8x4_t b);
 RV64:
   uint8x8_t __nds__v_scmplt8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__scmplt16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_scmplt16(int16x2_t a, int16x2_t b);
 RV64:
   uint16x4_t __nds__v_scmplt16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sll8(unsigned long a, unsigned int b);

 RV32:
   uint8x4_t __nds__v_sll8(uint8x4_t a, unsigned int b);
 RV64:
   uint8x8_t __nds__v_sll8(uint8x8_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sll16(unsigned long a, unsigned int b);

 RV32:
   uint16x2_t __nds__v_sll16(uint16x2_t a, unsigned int b);
 RV64:
   uint16x4_t __nds__v_sll16(uint16x4_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 long long __nds__smal(long long a, unsigned long b);

 RV32:
   long long __nds__v_smal(long long a, int16x2_t b);
 RV64:
   long __nds__v_smal(long a, int16x4_t b);
...
* SMALBB
 ...
 long long __nds__smalbb(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smalbb(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smalbb(long t, int16x4_t a, int16x4_t b);


* SMALBT

 long long __nds__smalbt(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smalbt(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smalbt(long t, int16x4_t a, int16x4_t b);

* SMALTT

 long long __nds__smaltt(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smaltt(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smaltt(long t, int16x4_t a, int16x4_t b);
...
* SMALDA
 ...
 long long __nds__smalda(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smalda(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smalda(long t, int16x4_t a, int16x4_t b);


* SMALXDA

 long long __nds__smalxda(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smalxda(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smalxda(long t, int16x4_t a, int16x4_t b);
...
* SMALDS
 ...
 long long __nds__smalds(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smalds(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smalds(long t, int16x4_t a, int16x4_t b);

* SMALDRS

 long long __nds__smaldrs(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smaldrs(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smaldrs(long t, int16x4_t a, int16x4_t b);

* SMALXDS

 long long __nds__smalxds(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smalxds(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long __nds__v_smalxds(long t, int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__smar64(long long t, long a, long b);

 RV64:
   long __nds__v_smar64(long t, int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 long __nds__smaqa(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smaqa(int t, int8x4_t a, int8x4_t b);
 RV64:
   int32x2_t __nds__v_smaqa(int32x2_t t, int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 long __nds__smaqa_su(long t, unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smaqa_su (int t, int8x4_t a, int8x4_t b);
 RV64:
   int32x2_t __nds__v_smaqa_su (int32x2_t t, int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__smax8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_smax8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_smax8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__smax16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_smax16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_smax16(int16x4_t a, int16x4_t b);
...
* SMBB16
 ...
 long __nds__smbb16(unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smbb16(int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smbb16(int16x4_t a, int16x4_t b);

* SMBT16

 long __nds__smbt16(unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smbt16(int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smbt16(int16x4_t a, int16x4_t b);

* SMTT16

 long __nds__smtt16(unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smtt16(int16x2_t a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smtt16(int16x4_t a, int16x4_t b);
...
* SMDS
 ...
 long __nds__smds(unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smds(int16x2_t a, int16x2_t b);
 RV64:
   int32x2 __nds__v_smds(int16x4_t a, int16x4_t b);

* SMDRS

 long __nds__smdrs(unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smdrs(int16x2_t a, int16x2_t b);
 RV64:
   int32x2 __nds__v_smdrs(int16x4_t a, int16x4_t b);

* SMXDS

 long __nds__smxds(unsigned long a, unsigned long b);

 RV32:
   int __nds__v_smxds(int16x2_t a, int16x2_t b);
 RV64:
   int32x2 __nds__v_smxds(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__smin8(unsigned long a, unsigned long b);

 RV32:
   int8x4_t __nds__v_smin8(int8x4_t a, int8x4_t b);
 RV64:
   int8x8_t __nds__v_smin8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__smin16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_smin16(int16x2_t a, int16x2_t b);
 RV64:
   int16x4_t __nds__v_smin16(int16x4_t a, int16x4_t b);
...
* SMMUL
 ...
 long __nds__smmul(long a, long b);

 RV64:
   int32x2_t __nds__v_smmul(int32x2_t a, int32x2_t b);

* SMMUL.u

 long __nds__smmul_u(long a, long b);

 RV64:
   int32x2_t __nds__v_smmul_u(int32x2_t a, int32x2_t b);
...
* SMMWB
 ...
 long __nds__smmwb(long a, unsigned long b);

 RV32:
   int __nds__v_smmwb(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smmwb(int32x2_t a, int16x4_t b);

* SMMWB.u

 long __nds__smmwb_u(long a, unsigned long b);

 RV32:
   int __nds__v_smmwb_u(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smmwb_u(int32x2_t a, int16x4_t b);
...
* SMMWT
 ...
 long __nds__smmwt(long a, unsigned long b);

 RV32:
   int __nds__v_smmwt(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smmwt(int32x2_t a, int16x4_t b);

* SMMWT.u

 long __nds__smmwt_u(long a, unsigned long b);

 RV32:
   int __nds__v_smmwt_u(int a, int16x2_t b);
 RV64:
   int32x2_t __nds__v_smmwt_u(int32x2_t a, int16x4_t b);
...
* SMSLDA
 ...
 long long __nds__smslda(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smslda(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long long __nds__v_smslda(long long t, int16x4_t a, int16x4_t b);


* SMSLXDA

 long long __nds__smslxda(long long t, unsigned long a, unsigned long b);

 RV32:
   long long __nds__v_smslxda(long long t, int16x2_t a, int16x2_t b);
 RV64:
   long long __nds__v_smslxda(long long t, int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__smsr64(long long t, long a, long b);

 RV64:
   long __nds__v_smsr64(long t, int32x2_t a, int32x2_t b);
...
For the “SMULX8” instruction, multiply the _first_ and _second_ 8-bit data elements of Rs1 with the _second_ and _first_ 8-bit data elements of Rs2. At the same time, multiply the _third_ and _fourth_ 8-bit data elements of Rs1 with the _fourth_ and _third_ 8-bit data elements of Rs2.
...
*RV64 Description:* For the “SMUL8” instruction, multiply the 8-bit data elements of Rs1 with the corresponding 8-bit data elements of Rs2.
...
* SMUL8
 ...
 unsigned long long __nds__smul8(unsigned int a, unsigned int b);

 int16x4_t __nds__v_smul8(int8x4_t a, int8x4_t b);


* SMULX8

 unsigned long long __nds__smulx8(unsigned int a, unsigned int b);

 int16x4_t __nds__v_smulx8(int8x4_t a, int8x4_t b);
...
* SMUL16
 ...
 unsigned long long __nds__smul16(unsigned int a, unsigned int b);

 int32x2_t __nds__v_smul16(int16x2_t a, int16x2_t b);


* SMULX16

 unsigned long long __nds__smulx16(unsigned int a, unsigned int b);

 int32x2_t __nds__v_smulx16(int16x2_t a, int16x2_t b);
...
*Intrinsic functions:*
 ...
 long __nds__sra_u(long a, unsigned int b);
...
* SRA8
 ...
 unsigned long __nds__sra8(unsigned long a, unsigned int b);

 RV32:
   int8x4_t __nds__v_sra8(int8x4_t a, unsigned int b);
 RV64:
   int8x8_t __nds__v_sra8(int8x8_t a, unsigned int b);

* SRA8.u

 unsigned long __nds__sra8_u(unsigned long a, unsigned int b);

 RV32:
   int8x4_t __nds__v_sra8_u(int8x4_t a, unsigned int b);
 RV64:
   int8x8_t __nds__v_sra8_u(int8x8_t a, unsigned int b);
...
* SRA16
 ...
 unsigned long __nds__sra16(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_sra16(int16x2_t a, unsigned int b);
 RV64:
   int16x4_t __nds__v_sra16(int16x4_t a, unsigned int b);


* SRA16.u

 unsigned long __nds__sra16_u(unsigned long a, unsigned long b);

 RV32:
   int16x2_t __nds__v_sra16_u(int16x2_t a, unsigned int b);
 RV64:
   int16x4_t __nds__v_sra16_u(int16x4_t a, unsigned int b);
...
* SRL8
 ...
 unsigned long __nds__srl8(unsigned long a, unsigned int b);

 RV32:
   uint8x4_t __nds__v_srl8(uint8x4_t a, unsigned int b);
 RV64:
   uint8x8_t __nds__v_srl8(uint8x8_t a, unsigned int b);


* SRL8.u

 unsigned long __nds__srl8_u(unsigned long a, unsigned int b);

 RV32:
   uint8x4_t __nds__v_srl8_u(uint8x4_t a, unsigned int b);
 RV64:
   uint8x8_t __nds__v_srl8_u(uint8x8_t a, unsigned int b);
...
* SRL16
 ...
 unsigned long __nds__srl16(unsigned long a, unsigned int b);

 RV32:
   uint16x2_t __nds__v_srl16(uint16x2_t a, unsigned int b);
 RV64:
   uint16x4_t __nds__v_srl16(uint16x4_t a, unsigned int b);


* SRL16.u

 unsigned long __nds__srl16_u(unsigned long a, unsigned int b);

 RV32:
   uint16x2_t __nds__v_srl16_u(uint16x2_t a, unsigned int b);
 RV64:
   uint16x4_t __nds__v_srl16_u(uint16x4_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__stas16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ustas16(uint16x2_t a, uint16x2_t b);
   int16x2_t __nds__v_sstas16(int16x2_t a, int16x2_t b);

 RV64:
   uint16x4_t __nds__v_ustas16(uint16x4_t a, uint16x4_t b);
   int16x4_t __nds__v_sstas16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__stsa16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ustsa16(uint16x2_t a, uint16x2_t b);
   int16x2_t __nds__v_sstsa16(int16x2_t a, int16x2_t b);

 RV64:
   uint16x4_t __nds__v_ustsa16(uint16x4_t a, uint16x4_t b);
   int16x4_t __nds__v_sstsa16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sub8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_usub8(uint8x4_t a, uint8x4_t b);
   int8x4_t __nds__v_ssub8(int8x4_t a, int8x4_t b);

 RV64:
   uint8x8_t __nds__v_usub8(uint8x8_t a, uint8x8_t b);
   int8x8_t __nds__v_ssub8(int8x8_t a, int8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sub16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_usub16(uint16x2_t a, uint16x2_t b);
   int16x2_t __nds__v_ssub16(int16x2_t a, int16x2_t b);

 RV64:
   uint16x4_t __nds__v_usub16(uint16x4_t a, uint16x4_t b);
   int16x4_t __nds__v_ssub16(int16x4_t a, int16x4_t b);
...
*Intrinsic functions:*
 ...
 long long __nds__ssub64(long long a, long long b);

 unsigned long long __nds__usub64(unsigned long long a, +
...
* SUNPK810
 ...
 unsigned long __nds__sunpkd810(unsigned long a);

 RV32:
   int16x2_t __nds__v_sunpkd810(int8x4_t a);
 RV64:
   int16x4_t __nds__v_sunpkd810(int8x8_t a);


* SUNPK820

 unsigned long __nds__sunpkd820(unsigned long a);

 RV32:
   int16x2_t __nds__v_sunpkd820(int8x4_t a);
 RV64:
   int16x4_t __nds__v_sunpkd820(int8x8_t a);

* SUNPK830

 unsigned long __nds__sunpkd830(unsigned long a);

 RV32:
   int16x2_t __nds__v_sunpkd830(int8x4_t a);
 RV64:
   int16x4_t __nds__v_sunpkd830(int8x8_t a);

* SUNPK831

 unsigned long __nds__sunpkd831(unsigned long a);

 RV32:
   int16x2_t __nds__v_sunpkd831(int8x4_t a);
 RV64:
   int16x4_t __nds__v_sunpkd831(int8x8_t a);

* SUNPK832

 unsigned long __nds__sunpkd832(unsigned long a);

 RV32:
   int16x2_t __nds__v_sunpkd832(int8x4_t a);
 RV64:
   int16x4_t __nds__v_sunpkd832(int8x8_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__swap8(unsigned long a);

 RV32:
   uint8x4_t __nds__v_swap8(uint8x4_t a);
 RV64:
   uint8x8_t __nds__v_swap8(uint8x8_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__swap16(unsigned long a);

 RV32:
   uint16x2_t __nds__v_swap16(uint16x2_t a);
 RV64:
   uint16x4_t __nds__v_swap16(uint16x4_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uclip8(unsigned long a, unsigned int b);

 RV32:
   uint8x4_t __nds__v_uclip8(uint8x4_t a, unsigned int b);
 RV64:
   uint8x8_t __nds__v_uclip8(uint8x8_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uclip16(unsigned long a, unsigned int b);

 RV32:
   uint16x2_t __nds__v_uclip16(uint16x2_t a, unsigned int b);
 RV64:
   uint16x4_t __nds__v_uclip16(uint16x4_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uclip32(unsigned long a, unsigned int b);

 RV64:
   uint32x2_t __nds__v_uclip32(uint32x2_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ucmple8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_ucmple8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_ucmple8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ucmple16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ucmple16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ucmple16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ucmplt8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_ucmplt8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_ucmplt8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ucmplt16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ucmplt16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ucmplt16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukadd8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_ukadd8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_ukadd8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukadd16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ukadd16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ukadd16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__ukadd64(unsigned long long a, +
 unsigned long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukaddh(unsigned int a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukaddw(unsigned int a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukcras16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ukcras16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ukcras16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukcrsa16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ukcrsa16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ukcrsa16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__ukmar64(unsigned long long t, +
 unsigned long a, unsigned long b);

 RV64:
   unsigned long long __nds__v_ukmar64(unsigned long long t, +
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__ukmsr64(unsigned long long t, +
 unsigned long a, unsigned long b);

 RV64:
   unsigned long long __nds__v_ukmsr64(unsigned long long t, +
   uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukstas16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ukstas16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ukstas16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukstsa16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ukstsa16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ukstsa16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uksub8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_uksub8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_uksub8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uksub16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_uksub16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_uksub16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__uksub64(unsigned long long a, +
 unsigned long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uksubh(unsigned int a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uksubw(unsigned int a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__umar64(unsigned long long t, +
 unsigned long a, unsigned long b);

 RV64:
   unsigned long long __nds__v_umar64(unsigned long long t, +
   uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umaqa(unsigned long t, unsigned long a, unsigned long b);

 RV32:
   unsigned int __nds__v_umaqa(unsigned int t, uint8x4_t a, uint8x4_t b);
 RV64:
   uint32x2_t __nds__v_umaqa(unsigned long t, uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umax8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_umax8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_umax8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umax16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_umax16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_umax16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umin8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_umin8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_umin8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umin16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_umin16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_umin16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__umsr64(unsigned long long t, unsigned long a, unsigned long b);

 RV64:
   unsigned long long __nds__v_umsr64(unsigned long long t, uint32x2_t a, uint32x2_t b);
...
* UMUL8
 ...
 unsigned long long __nds__umul8(unsigned int a, unsigned int b);
 uint16x4_t __nds__v_umul8(uint8x4_t a, uint8x4_t b);


* UMULX8

 unsigned long long __nds__umulx8(unsigned int a, unsigned int b);
 uint16x4_t __nds__v_umulx8(uint8x4_t a, uint8x4_t b);
...
* UMUL16
 ...
 unsigned long long __nds__umul16(unsigned int a, unsigned int b);
 uint32x2_t __nds__v_umul16(uint16x2_t a, uint16x2_t b);

* UMULX16

 unsigned long long __nds__umulx16(unsigned int a, unsigned int b);
 uint32x2_t __nds__v_umulx16(uint16x2_t a, uint16x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uradd8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_uradd8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_uradd8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uradd16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_uradd16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_uradd16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__uradd64(unsigned long long a, unsigned long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uraddw(unsigned int a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urcras16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_urcras16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_urcras16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urcrsa16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_urcrsa16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_urcrsa16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urstas16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_urstas16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_urstas16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urstsa16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_urstsa16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_urstsa16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ursub8(unsigned long a, unsigned long b);

 RV32:
   uint8x4_t __nds__v_ursub8(uint8x4_t a, uint8x4_t b);
 RV64:
   uint8x8_t __nds__v_ursub8(uint8x8_t a, uint8x8_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ursub16(unsigned long a, unsigned long b);

 RV32:
   uint16x2_t __nds__v_ursub16(uint16x2_t a, uint16x2_t b);
 RV64:
   uint16x4_t __nds__v_ursub16(uint16x4_t a, uint16x4_t b);
...
*Intrinsic functions:*
 ...
 unsigned long long __nds__ursub64(unsigned long long a, unsigned long long b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ursubw(unsigned int a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__wext(long long a, unsigned int b);
...
* ZUNPK810
 ...
 unsigned long __nds__zunpkd810(unsigned long a);

 RV32:
   uint16x2_t __nds__v_zunpkd810(uint8x4_t a);
 RV64:
   uint16x4_t __nds__v_zunpkd810(uint8x8_t a);

* ZUNPK820

 unsigned long __nds__zunpkd820(unsigned long a);

 RV32:
   uint16x2_t __nds__v_zunpkd820(uint8x4_t a);
 RV64:
   uint16x4_t __nds__v_zunpkd820(uint8x8_t a);

* ZUNPK830

 unsigned long __nds__zunpkd830(unsigned long a);

 RV32:
   uint16x2_t __nds__v_zunpkd830(uint8x4_t a);
 RV64:
   uint16x4_t __nds__v_zunpkd830(uint8x8_t a);

* ZUNPK831

 unsigned long __nds__zunpkd831(unsigned long a);

 RV32:
   uint16x2_t __nds__v_zunpkd831(uint8x4_t a);
 RV64:
   uint16x4_t __nds__v_zunpkd831(uint8x8_t a);

* ZUNPK832

 unsigned long __nds__zunpkd832(unsigned long a);

 RV32:
   uint16x2_t __nds__v_zunpkd832(uint8x4_t a);
 RV64:
   uint16x4_t __nds__v_zunpkd832(uint8x8_t a);

<<<
== Detailed Instruction Descriptions (RV64 Only)

The sections in this chapter describe the detailed operations of the DSP ISA extension instructions for RV64 only in alphabetical order.
...
*Intrinsic functions:*
 ...
 unsigned long __nds__add32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_uadd32(uint32x2_t a, uint32x2_t b);
 int32x2_t __nds__v_sadd32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__cras32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ucras32(uint32x2_t a, uint32x2_t b);
 int32x2_t __nds__v_scras32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__crsa32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ucrsa32(uint32x2_t a, uint32x2_t b);
 int32x2_t __nds__v_scrsa32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kabs32(unsigned long a);
 int32x2_t __nds__v_kabs32(int32x2_t a);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kadd32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kadd32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kcras32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kcras32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kcrsa32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kcrsa32(int32x2_t a, int32x2_t b);
...
* KDMBB16
 ...
 unsigned long __nds__kdmbb16(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kdmbb16(int16x4_t a, int16x4_t b);

* KDMBT16

 unsigned long __nds__kdmbt16(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kdmbt16(int16x4_t a, int16x4_t b);

* KDMTT16

 unsigned long __nds__kdmtt16(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kdmtt16(int16x4_t a, int16x4_t b);
...
* KDMABB16
 ...
 unsigned long __nds__kdmabb16(unsigned long t, unsigned long a, unsigned long b);
 int32x2_t __nds__v_kdmabb16(int32x2_t t, int16x4_t a, int16x4_t b);

* KDMABT16

 unsigned long __nds__kdmabt16(unsigned long t, unsigned long a, unsigned long b);
 int32x2_t __nds__v_kdmabt16(int32x2_t t, int16x4_t a, int16x4_t b);

* KDMATT16

 unsigned long __nds__kdmatt16(unsigned long t, unsigned long a, unsigned long b);
 int32x2_t __nds__v_kdmatt16(int32x2_t t, int16x4_t a, int16x4_t b);
...
* KHMBB16
 ...
 unsigned long __nds__khmbb16(unsigned long a, unsigned long b);
 int32x2_t __nds__v_khmbb16(int16x4_t a, int16x4_t b);

* KHMBT16

 unsigned long __nds__khmbt16(unsigned long a, unsigned long b);
 int32x2_t __nds__v_khmbt16(int16x4_t a, int16x4_t b);

* KHMTT16

 unsigned long __nds__khmtt16(unsigned long a, unsigned long b);
 int32x2_t __nds__v_khmtt16(int16x4_t a, int16x4_t b);
...
* KMABB32
 ...
 long __nds__kmabb32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmabb32(long t, int32x2_t a, int32x2_t b);

* KMABT32

 long __nds__kmabt32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmabt32(long t, int32x2_t a, int32x2_t b);

* KMATT32

 long __nds__kmatt32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmatt32(long t, int32x2_t a, int32x2_t b);
...
* KMADA32
 ...
 long __nds__kmada32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmada32(long t, int32x2_t a, int32x2_t b);

* KMAXDA32

 long __nds__kmaxda32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmaxda32(long t, int32x2_t a, int32x2_t b);
...
* KMDA32
 ...
 long __nds__kmda32(unsigned long a, unsigned long b);
 long __nds__v_kmda32(int32x2_t a, int32x2_t b);

* KMXDA32

 long __nds__kmxda32(unsigned long a, unsigned long b);
 long __nds__v_kmxda32(int32x2_t a, int32x2_t b);
...
* KMADS32
 ...
 long __nds__kmads32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmads32(long t, int32x2_t a, int32x2_t b);

* KMADRS32

 long __nds__kmadrs32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmadrs32(long t, int32x2_t a, int32x2_t b);

* KMAXDS32

 long __nds__kmaxds32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmaxds32(long t, int32x2_t a, int32x2_t b);
...
* KMSDA32
 ...
 long __nds__kmsda32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmsda32(long t, int32x2_t a, int32x2_t b);

* KMSXDA32

 long __nds__kmsxda32(long t, unsigned long a, unsigned long b);
 long __nds__v_kmsxda32(long t, int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ksll32(unsigned long a, unsigned int b);
 int32x2_t __nds__v_ksll32(int32x2_t a, unsigned int b);
...
* KSLRA32
 ...
 unsigned long __nds__kslra32(unsigned long a, int b);
 int32x2_t __nds__v_kslra32(int32x2_t a, int b);

* KSLRA32.u

 unsigned long __nds__kslra32_u(unsigned long a, int b);
 int32x2_t __nds__v_kslra32_u(int32x2_t a, int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kstas32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kstas32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__kstsa32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_kstsa32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ksub32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_ksub32(int32x2_t a, int32x2_t b);
...
* PKBB32
 ...
 unsigned long __nds__pkbb32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_pkbb32(uint32x2_t a, uint32x2_t b);

* PKBT32

 unsigned long __nds__pkbt32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_pkbt32(uint32x2_t a, uint32x2_t b);

* PKTB32

 unsigned long __nds__pktb32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_pktb32(uint32x2_t a, uint32x2_t b);

* PKTT32

 unsigned long __nds__pktt32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_pktt32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__radd32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_radd32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rcras32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_rcras32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rcrsa32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_rcrsa32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rstas32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_rstas32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rstsa32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_rstsa32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__rsub32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_rsub32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sll32(unsigned long a, unsigned int b);
 uint32x2_t __nds__v_sll32(uint32x2_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__smax32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_smax32(int32x2_t a, int32x2_t b);
...
* SMBB32
 ...
 long __nds__smbb32(unsigned long a, unsigned long b);
 long __nds__v_smbb32(int32x2_t a, int32x2_t b);

* SMBT32

 long __nds__smbt32(unsigned long a, unsigned long b);
 long __nds__v_smbt32(int32x2_t a, int32x2_t b);

* SMTT32

 long __nds__smtt32(unsigned long a, unsigned long b);
 long __nds__v_smtt32(int32x2_t a, int32x2_t b);
...
* SMDS32
 ...
 long __nds__smds32(unsigned long a, unsigned long b);
 long __nds__v_smds32(int32x2_t a, int32x2_t b);

* SMDRS32

 long __nds__smdrs32(unsigned long a, unsigned long b);
 long __nds__v_smdrs32(int32x2_t a, int32x2_t b);

* SMXDS32

 long __nds__smxds32(unsigned long a, unsigned long b);
 long __nds__v_smxds32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__smin32(unsigned long a, unsigned long b);
 int32x2_t __nds__v_smin32(int32x2_t a, int32x2_t b);
...
* SRA32
 ...
 unsigned long __nds__sra32(unsigned long a, unsigned int b);
 int32x2_t __nds__v_sra32(int32x2_t a, unsigned int b);

* SRA32.u

 unsigned long __nds__sra32_u(unsigned long a, unsigned int b);
 int32x2_t __nds__v_sra32_u(int32x2_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 long __nds__sraw_u(int a, unsigned int b);
...
* SRL32
 ...
 unsigned long __nds__srl32(unsigned long a, unsigned int b);
 uint32x2_t __nds__v_srl32(uint32x2_t a, unsigned int b);

* SRL32.u

 unsigned long __nds__srl32_u(unsigned long a, unsigned int b);
 uint32x2_t __nds__v_srl32_u(uint32x2_t a, unsigned int b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__stas32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ustas32(uint32x2_t a, uint32x2_t b);
 int32x2_t __nds__v_sstas32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__stsa32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ustsa32(uint32x2_t a, uint32x2_t b);
 int32x2_t __nds__v_sstsa32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__sub32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_usub32(uint32x2_t a, uint32x2_t b);
 int32x2_t __nds__v_ssub32(int32x2_t a, int32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukadd32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ukadd32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukcras32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ukcras32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
  ...
  unsigned long __nds__ukcrsa32(unsigned long a, unsigned long b);
  uint32x2_t __nds__v_ukcrsa32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukstas32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ukstas32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ukstsa32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ukstsa32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uksub32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_uksub32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umax32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_umax32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__umin32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_umin32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__uradd32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_uradd32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urcras32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_urcras32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urcrsa32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_urcrsa32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urstas32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_urstas32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__urstsa32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_urstsa32(uint32x2_t a, uint32x2_t b);
...
*Intrinsic functions:*
 ...
 unsigned long __nds__ursub32(unsigned long a, unsigned long b);
 uint32x2_t __nds__v_ursub32(uint32x2_t a, uint32x2_t b);
...
*IM Requirement:* Xdsp extension optional
...
This register stores the overflow flag of the P extension.
...
|OV |[0] <|Overflow flag. It will be set by many DSP instructions when a saturated result is generated. |RW |0
...
|*1100* |smul16h |smulx16h | |khm32 |smaqa |smaqa.su |umaqa
|wext

|*1101* |umul16h |umulx16h | |khmx32 | | | |wexti

|*1110* |ave | |sclip32 |bitrev |bitrevi | | |

|*1111* |minw |maxw |uclip32 | |mtlbi |mtlei |pbsad |pbsada
|===
...
|*0010* |raddw |rsubw |sra.u |ksll |smtt16 |kdmtt |khmtt |pktt16

|*0011* |uraddw |ursubw |sraiw.u |kslli |kmda |kmxda | |pktb16
...
|*1101* | |kdmabb |srai.u |kdmabb16 |kdmbb16 |khmbb16
|kmmawb2.u |

|*1110* |mulsr64 |kdmabt | | |kdmabt16 |kdmbt16 |khmbt16
|kmmwt2

|*1111* |mulr64 |kdmatt | | |kdmatt16 |kdmtt16 |khmtt16
|kmmwt2.u
|===
...
|*0000* |rstas32 |rstsa32 |rstas16 |rstsa16 | | | |

|*0001* |kstas32 |kstsa32 |kstas16 |kstsa16 | | | |

|*0010* |urstas32 |urstsa32 |urstas16 |urstsa16 | | | |

|*0011* |ukstas32 |ukstsa32 |ukstas16 |ukstsa16 | | | |

|*0100* |stas32 |stsa32 |stas16 |stsa16 | | | |
...
=== RV32 and RV64 Cores of 5 stage of pipeline

==== Listed by Individual Instruction

.RV64/RV32 of 5 Stages of Pipeline DSP Instruction Latency
...
.RV64 Only 5 Stages of Pipeline DSP Instruction Latency
[cols="^.^1,^.^3,^.^3,^.^3",options="header",]
|===
|No. |Instruction |Latency +
(cycle) |Throughput +
